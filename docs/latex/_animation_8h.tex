...
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{struct_animation}{Animation}} $\ast$ \mbox{\hyperlink{_animation_8h_a89bef044de34155e47dc1315f96267f8}{Animation\+Create}} (char $\ast$path, \mbox{\hyperlink{struct___model}{Model}} $\ast$model, char $\ast$name)
...
{\footnotesize\ttfamily \mbox{\hyperlink{struct_animation}{Animation}}$\ast$ Animation\+Create (\begin{DoxyParamCaption}\item[{char $\ast$}]{path,  }\item[{\mbox{\hyperlink{struct___model}{Model}} $\ast$}]{model,  }\item[{char $\ast$}]{name }\end{DoxyParamCaption})}
